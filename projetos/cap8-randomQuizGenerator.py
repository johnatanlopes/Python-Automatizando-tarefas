...
# Gera 35 arquivos contendo as programas
for quizNum in range(35):
    # Cria os arquivos com as provas e os gabaritos das respostas
    # A porcentagem será substituida por (quizNum)
    quizFile = open('C:\\tmp\\capitalsQuiz%s.txt' % (quizNum + 1), 'w')
    answerKeyFile = open('C:\\tmp\\capitalsQuiz_answers%s.txt' % (quizNum + 1), 'w')
